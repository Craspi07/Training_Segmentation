...
def run_pipeline(
    ...
    Args:
        ...
        inference_only: If True, skip training and run evaluation only.
        model_path: Path to a pre-trained model (required if inference_only).

    Returns:
        Dictionary with model_path and metrics.
    """
...
Examples:
  ...
  python pipeline.py --task dic --inference-only --model models/my_model
    ...
    parser.add_argument(
        "--task",
        choices=["dic", "fluor", "both"],
        default=None,
        help="Predefined task to run (dic, fluor, or both)",
    )
    parser.add_argument(
        "--config",
        type=str,
    ...
    parser.add_argument(
        "--inference-only",
        action="store_true",
        help="Skip training and run inference/evaluation only",
    )
    parser.add_argument(
        "--model",
        type=str,
        default=None,
        help="Path to pre-trained model (for inference-only mode)",
    )
